class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // add Spaceships (x3)
        this.ship04 = new Spaceship2(this, game.config.width + borderUISize*9, borderUISize * 4, 'cake', 0, 40).setOrigin(0,0);
    ...
    update() {
        ...
        // check collisions
        if(this.checkCollision2(this.p1Rocket, this.ship03)) {
            this.p1Rocket.reset();
            this.shipExplode(this.ship03);
        }
        if (this.checkCollision2(this.p1Rocket, this.ship02)) {
            this.p1Rocket.reset();
            this.shipExplode(this.ship02);
        }
        if (this.checkCollision2(this.p1Rocket, this.ship01)) {
            this.p1Rocket.reset();
            this.shipExplode(this.ship01);
        }
        if (this.checkCollision2(this.p1Rocket, this.ship04)) {
            this.p1Rocket.reset();
        ...
        if (this.checkCollision2(this.p2Rocket, this.ship04)) {
            this.p2Rocket.reset();
            this.shipExplode(this.ship04);
        }
    }
